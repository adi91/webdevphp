...
<body>
    ...
    <div class="page-content show-content">
		<div class="home-background">			
			<div class="offer-ticker alignleft">
                ...
                <ul class="clean-list services-list featured-items row">
                            ...
                            <figure class="ovh">
                                <a href="recipe.html" class="font-4x grey text-dark-blue hover-blue hover-scale-120 transition-medium">
									<div class="service-overlap">
										<img src="web/images/services/best-cousine.jpg" alt="Daily Tiffins" class="" />
                    ...
                    <li class="col-md-4 col-sm-4">
                        <div>
                            <figure class="ovh">
                                <a href="recipe.html" class="font-4x grey text-dark-blue hover-blue hover-scale-120 transition-medium">
                                    <img src="web/images/services/ideal-place.jpg" alt="Ideal Place" class="" />
                    ...
                    <li class="col-md-4 col-sm-4">
                        <div>
                            <figure class="ovh">
                                <a href="recipe.html" class="font-4x grey text-dark-blue hover-blue hover-scale-120 transition-medium">
                                    <img src="web/images/services/good-rest.jpg" alt="Good Rest" />
